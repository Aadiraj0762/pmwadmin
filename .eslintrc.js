...
module.exports = {
  extends: [
    ...
    'prettier',
    'plugin:react/recommended', // ✅ Added for React best practices
    'plugin:react-hooks/recommended' // ✅ Added for hooks improvements
  ],
  rules: {
    'jsx-a11y/alt-text': 'off',
    'react/display-name': 'off',
  ...
  settings: {
    ...
    'import/resolver': {
      node: {},
      typescript: {
        project: './jsconfig.json' // ✅ Ensuring TypeScript resolver works
      }
    }
  },
  overrides: []
