  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data?.AmenitiesData) {
        ...
        fetchAmenitiesData(); // ✅ Refresh data after update
      }
  
      // ✅ Show success alert
      setAlert({
        open: true,
        message: isEditMode ? 'Amenities updated successfully!' : 'Amenities added successfully!',
        severity: 'success'
      });
  
      // ✅ Refresh the page (only after showing alert)
      setTimeout(() => {
        location.reload();
      }, 1000);
      ...
      // ✅ Show error alert (ensure `error.message` is available)
      setAlert({
        open: true,
